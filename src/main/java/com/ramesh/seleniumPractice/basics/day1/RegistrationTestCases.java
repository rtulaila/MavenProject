...
@Test
	public void createAccount() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='email_create']")).sendKeys("seleniumNewbatch6@test.com");
		...
		yearDropDown.selectByValue("1988"); //yearDropDown.selectByVisibleText("1988  ");   //selecting year by visible text
